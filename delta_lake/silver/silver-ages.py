...
if __name__ == '__main__':
    ...
    silver_table_path = "hdfs://namenode:9000/tmp/silver_ages"
    ...
    timestamp_checkpoint_path = "hdfs://namenode:9000/tmp/silver_ages/last_checked_timestamp"
    ...
    while True:
        ...
        first_views_aggregated_data = (bronze_first_views_table
                                       .groupBy("video_id", "channel_id", "user_age")
                                       .agg(count("*").alias("views_count"))
                                       .select("video_id", "channel_id", "user_age", "views_count"))

        likes_aggregated_data = (bronze_likes_table
                                 .groupBy("video_id", "channel_id", "user_age")
                                 .agg(count("*").alias("likes_count"))
                                 .select("video_id", "channel_id", "user_age", "likes_count"))
