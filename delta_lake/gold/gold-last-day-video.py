...
if __name__ == '__main__':
    ...
    gold_table_path = "hdfs://namenode:9000/tmp/gold_last_day_video"
    ...
    while True:
        current_day = int(datetime.timestamp(datetime.now()))
        current_day = current_day - (current_day % (3600*24))
        ...
        silver_video_table = (spark
                              ...
                              .where((col("hour_timestamp") >= current_day)))
