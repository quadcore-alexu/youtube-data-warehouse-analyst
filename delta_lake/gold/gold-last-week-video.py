...
if __name__ == '__main__':
    ...
    gold_table_path = "hdfs://namenode:9000/tmp/gold_last_week_video"
    ...
    while True:
        current_week = int(datetime.timestamp(datetime.now()))
        current_week = current_week - (current_week % (3600*24*7))
        ...
        silver_video_table = (spark
                              ...
                              .where((col("hour_timestamp") >= current_week))
                              .groupBy("video_id")
