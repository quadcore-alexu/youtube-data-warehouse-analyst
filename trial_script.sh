...
API_ENDPOINTS=(
  ...
  "http://localhost:5000/delta/top_watched_videos?level=hour"
  "http://localhost:5000/delta/top_watched_videos?level=day"
  "http://localhost:5000/delta/top_watched_videos?level=week"
  "http://localhost:5000/delta/top_watched_videos?level=month"
  "http://localhost:5000/delta/top_watched_channels?level=hour"
  "http://localhost:5000/delta/top_watched_channels?level=day"
  "http://localhost:5000/delta/top_watched_channels?level=week"
  "http://localhost:5000/delta/top_watched_channels?level=month"
  "http://localhost:5000/delta/top_liked_videos?level=hour"
  "http://localhost:5000/delta/top_liked_videos?level=day"
  "http://localhost:5000/delta/top_liked_videos?level=week"
  "http://localhost:5000/delta/top_liked_videos?level=month"
  "http://localhost:5000/delta/top_liked_channels?level=hour"
  "http://localhost:5000/delta/top_liked_channels?level=day"
  "http://localhost:5000/delta/top_liked_channels?level=week"
  "http://localhost:5000/delta/top_liked_channels?level=month"
